...
const AddTrainer = () => {
    ...
    const [speciality, setSpeciality] = useState('Evolve yoga')
            ...
            <div className='bg-white px-8 py-8 border rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll'>
                ...
                <div className='flex flex-col lg:flex-row items-start gap-10 text-gray-600'>
                    ...
                    <div className='w-full lg:flex-1 flex flex-col gap-4'>
                        ...
                        <div className='flex-1 flex flex-col gap-1'>
                            <p>Fees</p>
                            <input onChange={e => setFees(e.target.value)} value={fees} className='border rounded px-3 py-2' type="number" placeholder='Trainer fees' required />
                        </div>
                    ...
                    <div className='w-full lg:flex-1 flex flex-col gap-4'>
                        ...
                        <div className='flex-1 flex flex-col gap-1'>
                            ...
                            <select onChange={e => setSpeciality(e.target.value)} value={speciality} className='border rounded px-2 py-2'>
                                <option value="Evolve yoga">Evolve yoga</option>
                                <option value="Strength +">Strength +</option>
                                <option value="Dance fitness">Dance fitness</option>
                                <option value="Cardio HIIT">Cardio HIIT</option>
                                <option value="Cycling boost">Cycling boost</option>
                                <option value="Boxing endurance">Boxing endurance</option>
                            </select>
                        </div>
                ...
                <div>
                    ...
                    <textarea onChange={e => setAbout(e.target.value)} value={about} className='w-full px-4 pt-2 border rounded' rows={5} placeholder='write about Trainer'></textarea>
                </div>
