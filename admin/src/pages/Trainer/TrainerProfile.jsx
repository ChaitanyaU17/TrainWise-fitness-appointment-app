...
const TrainerProfile = () => {
    ...
    const { dToken, profileData, setProfileData, getProfileData } = useContext(TrainerContext)
    ...
    const updateProfile = async () => {
        ...
        try {
            ...
            const { data } = await axios.post(backendUrl + '/api/trainer/update-profile', updateData, { headers: { dToken } })
