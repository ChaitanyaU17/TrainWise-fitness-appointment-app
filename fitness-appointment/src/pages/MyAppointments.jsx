          ...
          >
            ...
            <div className="flex-1 text-sm text-zinc-600 ">
              ...
              <p className="text-xs mt-1">
                <span className="text-sm text-neutral-700 font-medium">Date and Time: </span>25, July, 2024 | 8:30 PM
              </p>
            </div>
            <div className="flex flex-col gap-2 justify-end">
              ...
              <button className="text-sm text-stone-500 text-center sm:min-w-48 py-2 border rounded hover:bg-red-600 hover:text-white transition-all duration-300">Cancel Appointment</button> {/* Fixed typo here */}
            </div>
          </div>
        ))}
      </div>
